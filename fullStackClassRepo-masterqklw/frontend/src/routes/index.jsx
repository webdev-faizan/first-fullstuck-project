...
import UpdatePOst from "../components/updatpost";
  ...
  return (
    <Routes>
      ...
      <Route path="/nested" element={<Layout></Layout>}>
        ...
        <Route
          path="usereducer"
          element={<UseReducerHook></UseReducerHook>}
        ></Route>
        <Route
          path="rickandmorty"
          element={<RickAndMorty></RickAndMorty>}
        ></Route>
        ...
        <Route
          path="reactrouterdom"
          element={<ReactRouterDom></ReactRouterDom>}
        ></Route>
        <Route path="customhooks" element={<Hooks></Hooks>}></Route>
        <Route
          path="useContext-useState"
          element={<UseContextHook></UseContextHook>}
        ></Route>
        <Route
          path="statemanager"
